...
Use the configured architect runners. When absent, use one `inherit-parent` runner; configure several provider families with `/skill:setup-pstack` for whole-shape diversity.
